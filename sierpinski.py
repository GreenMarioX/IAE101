...
def sierpinski(degree, p1, p2, p3, color, line_width, screen):
    ...
    triPointOne = find_midpoint(p1, p2)
    triPointTwo = find_midpoint(p2, p3)
    triPointThree = p2
    sierpinski(degree - 1, triPointOne, triPointTwo, triPointThree, color, line_width, screen)

    triPointOne = find_midpoint(p1, p2)
    triPointTwo = find_midpoint(p1, p3)
    triPointThree = p1
    sierpinski(degree - 1, triPointOne, triPointTwo, triPointThree, color, line_width, screen)

    triPointOne = find_midpoint(p2, p3)
    triPointTwo = find_midpoint(p1, p3)
    triPointThree = p3
    sierpinski(degree - 1, triPointOne, triPointTwo, triPointThree, color, line_width, screen)
    pass
...
def main():
    ...
    degree = 3 # The degree of the Sierpinski triangle. This indicates how many
